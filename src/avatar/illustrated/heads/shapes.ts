...
export const HEAD_SHAPES: readonly HeadShape[] = [
  ...
  s('oval-long', 'Long oval', 'oval',
    [31, 67, 86, 94, 96, 92, 81, 65, 44, 22], 1.10, 'round', { noseT: 0.67 }),
  s('narrow-long', 'Narrow and long', 'narrow / long',
    [28, 61, 78, 85, 87, 83, 73, 58, 39, 20], 1.13, 'tapered', { noseT: 0.68, mouthT: 0.79 }),
  s('narrow-short', 'Narrow and short', 'narrow / short',
    [30, 65, 83, 89, 90, 86, 76, 62, 42, 22], 0.90, 'round', { noseT: 0.64 }),
  ...
  s('broad-short', 'Broad and short', 'broad / short',
    [42, 86, 108, 116, 118, 113, 101, 86, 60, 31], 0.89, 'square', { noseT: 0.63 }),
  s('rect-tall', 'Rectangular', 'rectangular',
    [33, 74, 95, 100, 101, 100, 96, 88, 66, 34], 1.11, 'square', { browT: 0.42, noseT: 0.67 }),
  s('square-heavy', 'Heavy square', 'square',
    [38, 80, 100, 106, 107, 106, 102, 95, 74, 40], 0.96, 'square'),
  s('square-broad', 'Broad square', 'square',
    [41, 85, 106, 113, 114, 113, 108, 99, 77, 42], 0.92, 'square', { noseT: 0.64 }),
  s('taper-v', 'Tapered', 'tapered',
    [35, 74, 95, 104, 106, 101, 84, 62, 38, 18], 1.02, 'tapered'),
  s('diamond', 'Diamond', 'diamond',
    [26, 58, 78, 92, 104, 106, 88, 64, 40, 19], 1.02, 'tapered', { browT: 0.39 }),
  s('round-full', 'Full round', 'round',
    [40, 82, 101, 109, 112, 110, 102, 86, 58, 30], 0.88, 'round', { noseT: 0.63, mouthT: 0.76 }),
  ...
  s('high-cheek', 'High cheekbone', 'high cheekbone',
    [31, 68, 87, 96, 103, 108, 88, 68, 45, 22], 1.04, 'angular', { eyeT: 0.445 }),
  s('broad-midface', 'Broad midface', 'broad midface',
    [33, 72, 90, 98, 103, 104, 103, 88, 60, 31], 0.97, 'round', { noseT: 0.67 }),
  s('forehead-tall', 'Tall forehead', 'tall forehead',
    [32, 72, 94, 102, 102, 96, 84, 68, 46, 23], 1.06, 'round',
    { browT: 0.455, eyeT: 0.50, noseT: 0.685, mouthT: 0.79 }),
  ...
  s('angular-lean', 'Lean and angular', 'narrow / long',
    [29, 64, 83, 92, 95, 93, 84, 72, 52, 26], 1.09, 'angular', { noseT: 0.67 }),
  ...
  s('inverted-egg', 'Inverted egg', 'broad lower face',
    [30, 65, 82, 89, 94, 99, 100, 93, 68, 36], 0.95, 'round', { noseT: 0.66 }),
];
